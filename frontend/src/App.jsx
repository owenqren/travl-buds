...
function App() {
    // State to hold the master list of trips
    const [trips, setTrips] = useState([]);
    // TODO: Remove later
    const currentUserId = 1;

    //Fetch all trips from Spring Boot when the app first opens
    useEffect(() => {
    ...
    // The function we pass to the form to update the UI instantly
